...
export const PasswordResetEmail = ({ link }: PasswordResetEmailProps) => {
  return (
    <Html>
      <Head />
      <Preview>You have submitted a password change request.</Preview>
      <Tailwind>
        <Body className="mx-auto my-auto bg-white px-2 font-sans">
          <Container className="mx-auto my-[40px] max-w-[465px] rounded border border-solid border-[#eaeaea] p-[20px]">
            ...
            <Text className="text-center text-[14px] leading-[24px] text-black">
              ...
              then confirm the password change by clicking the link below.
            </Text>
